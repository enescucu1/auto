...
Umgebungsvariable `client_secret` eintragen. ------------------------------------------------muss ab hier noch machen ------------------------------------
...
von `https://repo.maven.apache.org/maven2/com/h2database/h2/2.3.230/h2-2.3.230.jar`. -----hab ich heruntergeladen ist im Verzeichnis -------
