...
/**
 * Fehlerklassen für die Verwaltung von Autos, z.B. beim DB-Zugriff.
 * @packageDocumentation
 */

/**
 * Exception-Klasse für eine bereits existierende Fahrgestellnummer (FGNR).
 */
export class FgnrExistsException extends HttpException {
    ...
    constructor(fgnr: string | undefined) {
        super(
            `Die Fahrgestellnummer ${fgnr} existiert bereits.`,
